	...
	for i in nested:
		if vin[0:3] == i[0]:
			...
			if any(x in model.lower() for x in volkswagen_group):
				...
				cable = cable_list[4] + " and " + cable_list[5]
